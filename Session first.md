...
-->
    ...
    <div class="welcome-area" id="welcome">
        ...
        <div class="header-text">
			...
			<br><br><a href="#testimonials" class="main-button-caption"> Members </a>  <a href="#atestimonials" class="main-button-caption">Campus Ambassador</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div text-align= "center" class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter left move 50px over 0.6s after 0.4s">
                        <div class="pricing-body">
                            <div class="price-wrapper">
                               <a href="#testimonials" class="main-button-caption"> Members </a>
			       <br><br><br> <a href="#atestimonials" class="main-button-caption">Campus Ambassador</a>
                            </div>
                        </div>
			</div>
